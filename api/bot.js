                ...
                if (finalVideoUrl && finalId) {
                    ...
                    if (isChannel && msg.chat) {
                        ...
                        if (msg.chat.username) {
                            // Делаем ссылку на канал
                            sourceName = `<a href="https://t.me/${msg.chat.username}">${title}</a>`;
                        } else {
                            // Просто название, если нет юзернейма
                            sourceName = title;
                        }
                    }
                    // ------------------------------
                    ...
                    for (const adminId of adminUsers) {
                        try {
                             ...
                             await sendMessage(token, adminId, logCaption + `\n\n⚠️ Не удалось отправить файл, но в базу добавлено.`, null, 'HTML');
                        }
                    }
